...
enum opt_code
{
  ...
  OPT_m128bit_long_double = 984,             /* -m128bit-long-double */
  OPT_m32 = 985,                             /* -m32 */
  OPT_m3dnow = 986,                          /* -m3dnow */
  OPT_m3dnowa = 987,                         /* -m3dnowa */
  OPT_m64 = 988,                             /* -m64 */
  OPT_m80387 = 989,                          /* -m80387 */
  OPT_m8bit_idiv = 990,                      /* -m8bit-idiv */
  OPT_m96bit_long_double = 991,              /* -m96bit-long-double */
  OPT_mabi_ = 992,                           /* -mabi= */
  OPT_mabm = 993,                            /* -mabm */
  OPT_maccumulate_outgoing_args = 994,       /* -maccumulate-outgoing-args */
  OPT_maes = 995,                            /* -maes */
  OPT_malign_double = 996,                   /* -malign-double */
  OPT_malign_functions_ = 997,               /* -malign-functions= */
  OPT_malign_jumps_ = 998,                   /* -malign-jumps= */
  OPT_malign_loops_ = 999,                   /* -malign-loops= */
  OPT_malign_stringops = 1000,               /* -malign-stringops */
  OPT_mandroid = 1001,                       /* -mandroid */
  OPT_march_ = 1002,                         /* -march= */
  OPT_masm_ = 1003,                          /* -masm= */
  OPT_mavx = 1004,                           /* -mavx */
  OPT_mavx2 = 1005,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1006,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1007,  /* -mavx256-split-unaligned-store */
  OPT_mbionic = 1008,                        /* -mbionic */
  OPT_mbmi = 1009,                           /* -mbmi */
  OPT_mbmi2 = 1010,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1011,                  /* -mbranch-cost= */
  OPT_mcld = 1012,                           /* -mcld */
  OPT_mcmodel_ = 1013,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1014, */                    /* -mcpu= */
  OPT_mcrc32 = 1015,                         /* -mcrc32 */
  OPT_mcx16 = 1016,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1017,            /* -mdispatch-scheduler */
  OPT_mf16c = 1018,                          /* -mf16c */
  OPT_mfancy_math_387 = 1019,                /* -mfancy-math-387 */
  OPT_mfentry = 1020,                        /* -mfentry */
  OPT_mfma = 1021,                           /* -mfma */
  OPT_mfma4 = 1022,                          /* -mfma4 */
  OPT_mforce_drap = 1023,                    /* -mforce-drap */
  OPT_mfp_ret_in_387 = 1024,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1025,                       /* -mfpmath= */
  OPT_mfsgsbase = 1026,                      /* -mfsgsbase */
  /* OPT_mfused_madd = 1027, */              /* -mfused-madd */
  OPT_mglibc = 1028,                         /* -mglibc */
  OPT_mhard_float = 1029,                    /* -mhard-float */
  OPT_mieee_fp = 1030,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1031,      /* -mincoming-stack-boundary= */
  OPT_minline_all_stringops = 1032,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1033,  /* -minline-stringops-dynamically */
  /* OPT_mintel_syntax = 1034, */            /* -mintel-syntax */
  OPT_mlarge_data_threshold_ = 1035,         /* -mlarge-data-threshold= */
  OPT_mlwp = 1036,                           /* -mlwp */
  OPT_mlzcnt = 1037,                         /* -mlzcnt */
  OPT_mmmx = 1038,                           /* -mmmx */
  OPT_mmovbe = 1039,                         /* -mmovbe */
  OPT_mms_bitfields = 1040,                  /* -mms-bitfields */
  OPT_mno_align_stringops = 1041,            /* -mno-align-stringops */
  OPT_mno_fancy_math_387 = 1042,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1043,                  /* -mno-push-args */
  OPT_mno_red_zone = 1044,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1045,                       /* -mno-sse4 */
  OPT_momit_leaf_frame_pointer = 1046,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1047,                          /* -mpc32 */
  OPT_mpc64 = 1048,                          /* -mpc64 */
  OPT_mpc80 = 1049,                          /* -mpc80 */
  OPT_mpclmul = 1050,                        /* -mpclmul */
  OPT_mpopcnt = 1051,                        /* -mpopcnt */
  OPT_mprefer_avx128 = 1052,                 /* -mprefer-avx128 */
  OPT_mpreferred_stack_boundary_ = 1053,     /* -mpreferred-stack-boundary= */
  OPT_mpush_args = 1054,                     /* -mpush-args */
  OPT_mrdrnd = 1055,                         /* -mrdrnd */
  OPT_mrecip = 1056,                         /* -mrecip */
  OPT_mrecip_ = 1057,                        /* -mrecip= */
  OPT_mred_zone = 1058,                      /* -mred-zone */
  OPT_mregparm_ = 1059,                      /* -mregparm= */
  OPT_mrtd = 1060,                           /* -mrtd */
  OPT_msahf = 1061,                          /* -msahf */
  OPT_msoft_float = 1062,                    /* -msoft-float */
  OPT_msse = 1063,                           /* -msse */
  OPT_msse2 = 1064,                          /* -msse2 */
  OPT_msse2avx = 1065,                       /* -msse2avx */
  OPT_msse3 = 1066,                          /* -msse3 */
  OPT_msse4 = 1067,                          /* -msse4 */
  OPT_msse4_1 = 1068,                        /* -msse4.1 */
  OPT_msse4_2 = 1069,                        /* -msse4.2 */
  OPT_msse4a = 1070,                         /* -msse4a */
  /* OPT_msse5 = 1071, */                    /* -msse5 */
  OPT_msseregparm = 1072,                    /* -msseregparm */
  OPT_mssse3 = 1073,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1074,               /* -mstack-arg-probe */
  OPT_mstackrealign = 1075,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1076,            /* -mstringop-strategy= */
  OPT_mtbm = 1077,                           /* -mtbm */
  OPT_mtls_dialect_ = 1078,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1079,           /* -mtls-direct-seg-refs */
  OPT_mtune_ = 1080,                         /* -mtune= */
  OPT_muclibc = 1081,                        /* -muclibc */
  OPT_mveclibabi_ = 1082,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1083,              /* -mvect8-ret-in-mem */
  OPT_mvzeroupper = 1084,                    /* -mvzeroupper */
  OPT_mx32 = 1085,                           /* -mx32 */
  OPT_mxop = 1086,                           /* -mxop */
  OPT_n = 1087,                              /* -n */
  OPT_no_canonical_prefixes = 1088,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1089,              /* -no-integrated-cpp */
  OPT_nocpp = 1090,                          /* -nocpp */
  OPT_nodefaultlibs = 1091,                  /* -nodefaultlibs */
  OPT_nostartfiles = 1092,                   /* -nostartfiles */
  OPT_nostdinc = 1093,                       /* -nostdinc */
  OPT_nostdinc__ = 1094,                     /* -nostdinc++ */
  OPT_nostdlib = 1095,                       /* -nostdlib */
  OPT_nostdlib__ = 1096,                     /* -nostdlib++ */
  OPT_o = 1097,                              /* -o */
  OPT_p = 1098,                              /* -p */
  ...
  OPT_print_objc_runtime_info = 1111,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1112,               /* -print-prog-name= */
  OPT_print_search_dirs = 1113,              /* -print-search-dirs */
  OPT_print_sysroot = 1114,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1115,   /* -print-sysroot-headers-suffix */
  OPT_profile = 1116,                        /* -profile */
  OPT_pthread = 1117,                        /* -pthread */
  OPT_quiet = 1118,                          /* -quiet */
  OPT_r = 1119,                              /* -r */
  OPT_rdynamic = 1120,                       /* -rdynamic */
  OPT_remap = 1121,                          /* -remap */
  OPT_s = 1122,                              /* -s */
  OPT_s_bc_abi = 1123,                       /* -s-bc-abi */
  OPT_save_temps = 1124,                     /* -save-temps */
  OPT_save_temps_ = 1125,                    /* -save-temps= */
  OPT_shared = 1126,                         /* -shared */
  OPT_shared_libgcc = 1127,                  /* -shared-libgcc */
  /* OPT_specs = 1128, */                    /* -specs */
  OPT_specs_ = 1129,                         /* -specs= */
  OPT_static = 1130,                         /* -static */
  OPT_static_libgcc = 1131,                  /* -static-libgcc */
  OPT_static_libgcj = 1132,                  /* -static-libgcj */
  OPT_static_libgfortran = 1133,             /* -static-libgfortran */
  OPT_static_libgo = 1134,                   /* -static-libgo */
